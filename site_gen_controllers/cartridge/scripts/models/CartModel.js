...
var CartModel = AbstractModel.extend({
    ...
    addBonusProduct: function (bonusDiscountLineItem, product, selectedOptions, quantity) {
        ...
        var UpdateProductOptionSelections = require('site_gen_core/cartridge/scripts/cart/UpdateProductOptionSelections');
    ...
    validateForCheckout: function () {
        var ValidateCartForCheckout = require('site_gen_core/cartridge/scripts/cart/ValidateCartForCheckout');
